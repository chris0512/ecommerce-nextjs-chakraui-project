        ...
        <Container as='footer' role='contentinfo' maxW='7xl'>
            <Stack
                ...
                <Stack spacing={{ base: '6', md: '8' }} align='start'>
                    <Flex alignItems='center'>
                        <Icon as={GiShoppingBag} h={10} w={10} color='orange.400' />
                        <Text fontSize='2xl' fontWeight='extrabold'>
                            Shopping Site
                        </Text>
                    </Flex>
                    <Text color='muted'>Check out new equipment</Text>
                </Stack>
            ...
            <Stack pt='8' pb='12' justify='space-between' direction={{ base: 'column-reverse', md: 'row' }} align='center'>
                <Text fontSize='sm' color='subtle'>
                    &copy; {new Date().getFullYear()} Chris0512, Inc. All rights reserved.
                </Text>

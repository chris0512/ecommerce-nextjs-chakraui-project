    ...
    return (
        <Stack
            ...
            <Box flex='1' maxH='5' alignItems='baseline'>
                {product.stock <= 0 && (
                    <Badge rounded='full' px='2' fontSize='0.8em' backgroundColor="red.500">
                        Sold Out
                    </Badge>
                )}
                {product.productIsNew && (
                    <Badge rounded='full' px='2' fontSize='1em' backgroundColor="green.500">
                        New
                    </Badge>
                )}
            </Box>
            ...
            <Flex justify='space-between'>
                ...
                <Tooltip hasArrow  label='Add to cart' bg='white' placement={'top'} color='gray.800' fontSize="xl" fontWeight="500" borderRadius="10px">
